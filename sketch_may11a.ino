...
#define SSID "Moto"     // Enter Your WiFi Name Here 
#define PASS "rijul@22"       // Enter Your WiFi Password Here
#define IP "api.thingspeak.com"// thingspeak.com ip

String msg = "GET/update?key=LT9C63YTC91A0OPF"; //Enter your API key
